...
_Utilisé pour le partage de fichiers, l'impression, et certaines interactions à distance sous Windows._
...
_Utilisé pour interroger et interagir avec l'annuaire Active Directory._
...
netexec rdp <cible> -u <user> -p <pass |
```