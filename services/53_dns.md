---
description: Domain Name System, port 53, TCP/UDP Résolution des noms de domaines.
---
...
Zone transfer (Permet à un serveur DNS de transférer sa zone à un autre serveur DNS en cas de problème. En cas de maucaise configuration il est possible pour nous aussi de faire une demande de transfer et de récupérer les information.):
